                ...
                <div className='flex flex-col lg:flex-row items-center lg:items-start gap-8'>
                    ...
                    <div className='lg:w-1/2'>
                        {/* <div className="grid grid-cols-2 gap-2 px-4 my-4">
                            <img className="w-full h-52  object-cover rounded-tl-md rounded-es-[80px] rounded-se-[80px]" src="/image/4cards/image1.jpeg" alt="Card 1" />
                            <img className="w-full h-52 object-cover rounded-tr-md rounded-br-[80px] rounded-tl-[80px]" src="/image/4cards/image2.jpeg" alt="Card 2" />
                            <img className="w-full h-52 object-cover rounded-bl-md rounded-br-[80px] rounded-tl-[80px]" src="/image/4cards/image3.jpeg" alt="Card 3" />
                            <img className="w-full h-52 object-cover rounded-br-md rounded-es-[80px] rounded-se-[100px]" src="/image/4cards/image4.jpeg" alt="Card 4" />
                        </div> */}
                        {/* 
                        <div className="grid grid-cols-2 gap-2 px-4 my-4">
                            <img className="w-full h-32 sm:h-40 md:h-52 object-cover rounded-tl-md rounded-es-[80px] rounded-se-[80px]" src="/image/4cards/image1.jpeg" alt="Card 1" />
                            <img className="w-full h-32 sm:h-40 md:h-52 object-cover rounded-tr-md rounded-br-[80px] rounded-tl-[80px]" src="/image/4cards/image2.jpeg" alt="Card 2" />
                            <img className="w-full h-32 sm:h-40 md:h-52 object-cover rounded-bl-md rounded-br-[80px] rounded-tl-[80px]" src="/image/4cards/image3.jpeg" alt="Card 3" />
                            <img className="w-full h-32 sm:h-40 md:h-52 object-cover rounded-br-md rounded-es-[80px] rounded-se-[80px]" src="/image/4cards/image4.jpeg" alt="Card 4" />
                        </div> */}
                        <div className="grid grid-cols-2 gap-1 sm:gap-2 px-2 sm:px-4 my-2 sm:my-4">
                            <img className="w-full h-24 sm:h-40 md:h-52 object-cover 
                    ...
                    rounded-se-[40px] sm:rounded-se-[60px] md:rounded-se-[80px]"
                                src="/image/4cards/image1.jpeg" alt="Card 1" />
                            <img className="w-full h-24 sm:h-40 md:h-52 object-cover 
                    ...
                    rounded-tl-[40px] sm:rounded-tl-[60px] md:rounded-tl-[80px]"
                                src="/image/4cards/image2.jpeg" alt="Card 2" />
                            <img className="w-full h-24 sm:h-40 md:h-52 object-cover 
                    rounded-bl-sm sm:rounded-bl-md 
                    rounded-br-[40px] sm:rounded-br-[60px] md:rounded-br-[80px] 
                    rounded-tl-[40px] sm:rounded-tl-[60px] md:rounded-tl-[80px]"
                                src="/image/4cards/image3.jpeg" alt="Card 3" />
                            <img className="w-full h-24 sm:h-40 md:h-52 object-cover 
                    rounded-br-sm sm:rounded-br-md 
                    rounded-es-[40px] sm:rounded-es-[60px] md:rounded-es-[80px] 
                    rounded-se-[40px] sm:rounded-se-[60px] md:rounded-se-[80px]"
                                src="/image/4cards/image4.jpeg" alt="Card 4" />
                        </div>
                    </div>
                </div>
            </div>
