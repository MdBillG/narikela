...
export default function AboutUs() {
    ...
    return (
        <>
            <div className="relative w-full h-full bg-[#EBEAD5] my-3">
                        ...
                        <div className="container mx-auto px-4 py-8">
                            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8">
                                <div className="lg:w-1/2 sm:pt-16 md:pt-16 px-3 flex flex-col gap-2">
                                    <h1 className="text-xl   font-cormorant text-[#593B1F] font-semibold italic text-center sm:text-start">ABOUT US</h1>
                                    <h2 className="text-4xl font-medium font-cormorant text-[#1B2F1F]  text-center sm:text-start">
                                        Generations of Purity
                                    </h2>
                                    <p className=" font-poppins sm:text-sm  text-[16px] text-center sm:text-start">
                                    ...
                                    <button onClick={() => router.push("/about")} className='bg-[#D1B87A] p-2 text-[#1B2F1F] rounded font-poppins sm:w-[30%] w-[60%]   sm:justify-start sm:block hidden '>Know More</button>
                                    <button onClick={() => router.push("/about")} className='bg-[#D1B87A] p-2 text-[#1B2F1F] rounded font-poppins sm:w-[30%] w-[60%] flex justify-center mx-auto sm:justify-start sm:hidden text-lg'>Know More</button>
                                </div>
