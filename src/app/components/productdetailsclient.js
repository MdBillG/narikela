        ...
        <div className=" ">
            ...
            <div className="mx-2">
                ...
                <div className="sm:ml-[100px] lg:ml-[100px] md:ml[100pxs] ml-2 ">
                    <div className=" text-xl font-semibold text-[#593B1F]  italic py-3 sm:w-3/4 mx-auto">
                        NARIKELA TREASURES
                    </div>
                </div>
                <div className="flex sm:justify-center sm:flex-row  justify-center ">
                    ...
                    <div className=" flex sm:flex-col sm:ml-4 sm:justify-end sm:my-2 flex-col justify-end mb-2 sm:flex hidden ">
                        <div className="font-poppins mr-2">
                            <p className="font-poppins font-semibold sm:text-xs text-[10px]  ">
                                {name}
                            </p>
                            <h6 className="font-[1px] sm:text-[7px] text-[5px]">
                ...
                <div className=" sm:my-10 my-3">
                    <h1 className="sm:w-4/5 w-[96%] sm:mx-auto text-[#1B2F1F] font-semibold sm:text-xl font-poppins border-b border-[#593B1F] mx-auto">
                        Product Description
                    </h1>

                    <div className="sm:w-4/5 w-[93%] mx-auto my-2 font-poppins flex flex-col gap-2 ">
                        <div className="flex gap-1 sm:text-xl text-xs">
                            <p className=" sm:text-xl font-medium text-[#1B2F1F] text-xs ">
                                Size :
                            </p>
                            <p className="mt-[px] sm:text-xl text-xs"> {size}</p>
                        </div>
                        <div className="flex gap-1 sm:text-xl text-xs">
                            <p className="sm:text-xl font-medium text-[#1B2F1F]  text-xs">
                                Used For :
                            </p>{" "}
                            <p className="mt-[x] sm:text-xl text-xs">
                                Cooking oil, Body Lotion, Hair Oil
                            </p>
                        </div>
                        <p className="text-[#1B2F1F] sm:text-xl text-xs ">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui sunt
                            iure quam illum nobis, modi suscipit assumenda alias. Voluptates
                            quidem quod nesciunt id quae labore non sequi? Odit, magnam velit?
                        </p>
                    </div>
                </div>
                <div className=" sm:w-4/5 w-[96%] mx-auto text-[#1B2F1F] font-semibold sm:text-xl font-poppins  border-b border-[#593B1F] my-3">
                ...
                <div className=" sm:w-4/5  mx-auto  flex justify-center sm:block hidden ">
                    <img
                        className=" sm:w-6/7  w-[94%] mt-2"
                        src="/image/pdp/group.png"
                        alt=""
                    />
                </div>
                <PdpKeyFeatures />
                <div className=" sm:w-4/5 w-[96%] mx-auto text-[#1B2F1F] font-semibold sm:text-xl font-poppins my-2 border-b border-[#593B1F] my-3">
