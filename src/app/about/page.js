        ...
        <>
            ...
            <div className='mx-3 my-3'>
                ...
                <div className="grid sm:grid-cols-2 grid-cols-1 sm:mx-16 sm:my-10 mt-4 ">
                    ...
                    <div className="sm:my-5 my-3  sm:text-start text-center">
                        <h1 className="text-[#593B1F] font-cormorant italic text-2xl ">
                            ABOUT US
                        </h1>
                        <h3 className="text-[#1B2F1F] font-cormorant font-medium text-2xl tracking-wide mt-2">
                            Generations of Purity
                        </h3>
                        <p className="text-[#000000 ] font-poppins font-normal sm:text-sm text-[16px] mt-2">
                ...
                <div className="bg-[#EBEAD5] my-3">
                    ...
                    <div className="flex sm:flex-row flex-col justify-center ">
                        ...
                        <div className="flex sm:flex-col flex-col gap-2 items-center">
                            <div className=" bg-[#F3EEE1]   rounded-3xl  text-center my-auto drop-shadow-lg border border-[#D1B87A] text-[#593B1F] border-opacity-50 flex items-center justify-center font-cormorant p-2">
                ...
                <div className="grid sm:grid-cols-2 grid-cols-1 sm:w-2/3 mx-auto sm:py-4 my-3">
                    <h2 className=" sm:hidden block text-[#593B1F] font-medium text-2xl italic  font-cormorant text-center my-4">
                        MEET THE VISIONARY
                    </h2>
                    <div>
                        <img
                            className="sm:ml-32 sm:h-72  sm:pl-3 sm:pr-3"
